...
@Component({
  selector: 'app-supervisor-report-v1',
  templateUrl: './supervisor-report-v1.component.html',
  styleUrls: ['./supervisor-report-v1.component.scss']
})
export class SupervisorReportV1Component implements OnInit {
  db: any
  cityName: any;
