...
@Component({
  selector: "app-ward-survey-analysis-v1",
  templateUrl: "./ward-survey-analysis-v1.component.html",
  styleUrls: ["./ward-survey-analysis-v1.component.scss"],
})
export class WardSurveyAnalysisV1Component {
