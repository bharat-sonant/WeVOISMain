...
@Component({
  selector: "app-house-marking-assignment-v1",
  templateUrl: "./house-marking-assignment-v1.component.html",
  styleUrls: ["./house-marking-assignment-v1.component.scss"],
})
export class HouseMarkingAssignmentV1Component implements OnInit {
