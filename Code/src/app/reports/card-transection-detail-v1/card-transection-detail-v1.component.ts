...
@Component({
  selector: 'app-card-transection-detail-v1',
  templateUrl: './card-transection-detail-v1.component.html',
  styleUrls: ['./card-transection-detail-v1.component.scss']
})
export class CardTransectionDetailV1Component implements OnInit {
