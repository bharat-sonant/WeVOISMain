...
@Component({
  selector: 'app-due-amount-report-v1',
  templateUrl: './due-amount-report-v1.component.html',
  styleUrls: ['./due-amount-report-v1.component.scss']
})
export class DueAmountReportV1Component implements OnInit {
