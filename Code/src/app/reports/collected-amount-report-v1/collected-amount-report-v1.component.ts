...
@Component({
  selector: 'app-collected-amount-report-v1',
  templateUrl: './collected-amount-report-v1.component.html',
  styleUrls: ['./collected-amount-report-v1.component.scss']
})
export class CollectedAmountReportV1Component implements OnInit {
