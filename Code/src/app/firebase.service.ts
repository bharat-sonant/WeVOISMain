...
export class FirebaseService {
  ...
  getDatabaseByCity(city: any) {    
    ...
    if (detail != undefined) {
      this.fireBase = {
        ...
        authDomain: detail.authDomain,
        databaseURL: detail.databaseURL,
        projectId: detail.projectId,
        storageBucket: detail.storageBucket,
        messagingSenderId: detail.messagingSenderId
      };
  ...
  this.fireBase = {
    apiKey: "AIzaSyBGZ_IB4y5Ov1nuqIhWndGU8hfJadlE85I",
    authDomain: "dtdnavigator.firebaseapp.com",
    databaseURL: "https://dtdnainwan.firebaseio.com",
    projectId: "dtdnavigator",
    storageBucket: "dtdnavigator.appspot.com",
    messagingSenderId: "381118272786",
  };
  databaseName = "dtdnainwan";
  databaseURL = "https://dtdnainwan.firebaseio.com";
}
    */
