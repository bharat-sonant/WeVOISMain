...
@Component({
  selector: 'app-manage-marking-data-v1',
  templateUrl: './manage-marking-data-v1.component.html',
  styleUrls: ['./manage-marking-data-v1.component.scss']
})
export class ManageMarkingDataV1Component implements OnInit {
