...
@Component({
  selector: 'app-card-marker-mapping-v1',
  templateUrl: './card-marker-mapping-v1.component.html',
  styleUrls: ['./card-marker-mapping-v1.component.scss']
})
export class CardMarkerMappingV1Component implements OnInit {
