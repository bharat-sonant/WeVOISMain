...
@Component({
  selector: 'app-secondary-collection-service',
  templateUrl: './secondary-collection-service.component.html',
  styleUrls: ['./secondary-collection-service.component.scss']
})
export class SecondaryCollectionServiceComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.commonService.savePageLoadHistory("Secondary-Collection-Management","Secondary-Collection-Offline-Entry",localStorage.getItem("userID"));
    this.setDefault();
  }
