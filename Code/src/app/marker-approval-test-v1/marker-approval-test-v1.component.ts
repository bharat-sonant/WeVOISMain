...
@Component({
  selector: 'app-marker-approval-test-v1',
  templateUrl: './marker-approval-test-v1.component.html',
  styleUrls: ['./marker-approval-test-v1.component.scss']
})
export class MarkerApprovalTestV1Component {
