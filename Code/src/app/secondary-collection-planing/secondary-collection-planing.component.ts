...
@Component({
  selector: 'app-secondary-collection-planing',
  templateUrl: './secondary-collection-planing.component.html',
  styleUrls: ['./secondary-collection-planing.component.scss']
})
export class SecondaryCollectionPlaningComponent implements OnInit {
