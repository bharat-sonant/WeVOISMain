 ...
 */
@Component({
  selector: 'app-action-history-v1',
  templateUrl: './action-history-v1.component.html',
  styleUrls: ['./action-history-v1.component.scss']
})
export class ActionHistoryV1Component {
  ...
  constructor(private moveHelper: MoveHelperV1Service) {
