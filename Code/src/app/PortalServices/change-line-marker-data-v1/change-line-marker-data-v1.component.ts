...
import { MoveHelperV1Service } from '../../services/common/move-helper-v1.service';
...
@Component({
  selector: 'app-change-line-marker-data-v1',
  templateUrl: './change-line-marker-data-v1.component.html',
  styleUrls: ['./change-line-marker-data-v1.component.scss']
})
export class ChangeLineMarkerDataV1Component implements OnInit, OnDestroy {

  constructor(public fs: FirebaseService, private besuh: BackEndServiceUsesHistoryService, private storage: AngularFireStorage, private commonService: CommonService, public httpService: HttpClient, private modalService: NgbModal, public moveHelper: MoveHelperV1Service, private markerMapping: MarkerMappingService, private router: Router, private route: ActivatedRoute) { }
  ...
  // ---- move progress state (bound to app-marker-move-progress-v1) ----
