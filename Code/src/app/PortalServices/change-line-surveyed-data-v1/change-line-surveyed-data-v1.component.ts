...
import { MarkerMoveRow, MarkerMoveSummary } from '../marker-move-progress-v1/marker-move-progress-v1.component';
import { MarkerMappingService } from '../../services/marker/marker-mapping.service';

@Component({
  selector: 'app-change-line-surveyed-data-v1',
  templateUrl: './change-line-surveyed-data-v1.component.html',
  styleUrls: ['./change-line-surveyed-data-v1.component.scss']
})
export class ChangeLineSurveyedDataV1Component implements OnInit, OnDestroy {

  constructor(public fs: FirebaseService, private besuh: BackEndServiceUsesHistoryService, private commonService: CommonService, private storage: AngularFireStorage, public moveHelper: MoveHelperV1Service, private modalService: NgbModal, private markerMapping: MarkerMappingService) { }
