      ...
      for (let i = 1; i < 2; i++) {
        ...
        let workDetail = this.db
          ...
          .subscribe((data) => {
            ...
            if (data != null) {
              let wardDetails = this.workList.find(
          ...
          if (workerData["WorkerDetails"]["driver"] != null) {
            ...
            if (lineStatus != null) {
              if (lineStatus.length > 0) {
                ...
                lineStatus = this.commonService.transform(
                  lineStatus,
                  "position"
                );
                if (
                  lineStatus[0]["start-time"] != "undefined" &&
                  lineStatus[0]["start-time"] != null
                ) {
                          ...
                          if (data["task" + i + ""]["in-out"] != null) {
                            if (startTime == "") {
                              ...
                              startTime =
                                ...
                                removeSecond[1];
                              startTime =
                                this.commonService.convert24(startTime);
                              ...
                              let driverPath =
                                "Employees/" + driverId + "/GeneralDetails";
                              let drivers = this.db
                                .object(driverPath)
                                .valueChanges()
                                .subscribe((driverData) => {
                                  if (driverData != null) {
                                    ...
                                    if (zoneDetails != undefined) {
                                      ...
                                      zoneDetails.wardReachingDuration =
                                        duration;
                                      zoneDetails.wardReachingCost = cost;
                                      zoneDetails.driverName =
                                        driverData["name"];
                                    }
                                  }
                                  drivers.unsubscribe();
